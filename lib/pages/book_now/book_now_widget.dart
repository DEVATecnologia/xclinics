                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowChoiceChips(
                              options: [
                                ...
                                ChipData(FFLocalizations.of(context).getText(
                                  'pomfl5zt' /* No Breakfast */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  'f1fe7s13' /* Hot Tub Access */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  'zzic02za' /* No Access */,
                                ))
