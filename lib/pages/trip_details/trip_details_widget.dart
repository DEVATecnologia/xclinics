                  ...
                  if (widget.tripRef?.complete ?? true)
                    Column(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'nxp76u8n' /* Your trip has been completed! */,
                          ),
                          style:
